...
$(document).ready(function () {
  $("#savings-withdraw").click(function () {
    ...
    if (savingsWithdrawalInputString.includes("-")) {
      savingsWithdrawalInputString = savingsWithdrawalInputString.replace(
        /-/g,
        ""
      );
      console.log(
        "savingsWithdrawalInputString: ",
        savingsWithdrawalInputString
      );
    }
...
$(document).ready(function () {
  $("#savings-withdraw").click(function () {
    ...
    // overdraft protection 1 - stop withdrawal, withdrawal amount is > savings balance
      ...
      savingsWithdrawalInput > savingsBalance &&
      savingsWithdrawalInput > savingsBalance + checkingBalance
    ) {
...
$(document).ready(function () {
  $("#checking-withdraw").click(function () {
    ...
    if (checkingWithdrawalInputString.includes("-")) {
      checkingWithdrawalInputString = checkingWithdrawalInputString.replace(
        /-/g,
        ""
      );
...
$(document).ready(function () {
  $("#checking-withdraw").click(function () {
    ...
    // overdraft protection 1 - stop withdrawal, withdrawal amount is > savings balance
      ...
      checkingWithdrawalInput > checkingBalance &&
      checkingWithdrawalInput > savingsBalance + checkingBalance
    ) {
    ...
    // overdraft protection 2 -taking from checking account if sufficient
      ...
      checkingNegativeBalance = String(checkingNegativeBalance).replace(
        /-/g,
        ""
      );
